    ...
    <div>
      ...
      <div className='Center'>
        <div className='picturesZone row wrap '>
          ...
          <div className='imageZone' id='pic2' style={{ borderRadius: 5, margin: 10, height: 360, width: 748, backgroundImage: "url('https://infisure.co.nz/indianlounge/wp-content/uploads/2022/09/IndianLounge-09August2022-18-768x512.jpg')" }}></div>
